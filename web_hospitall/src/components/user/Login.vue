    ...
    <div class="login" id="login">
        <div class="login__container">
            ...
            <div>
                ...
                <input :class="{'error':messageError.email}" v-model="account.email" type="text" placeholder="Địa chỉ email">
                <p>{{messageError.email}}</p>
            </div>
            <div>
                <span class="bx bx-lock"></span>
                <input :class="{'error':messageError.password}" v-model="account.password" type="password" placeholder="Mật khẩu">
